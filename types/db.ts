...
// Note: the `doctors` table actually holds all clinic staff

// including doctors, medical assistants, and admins.

// `role` distinguishes doctor vs medical_assistant vs admin.

export type Doctor = {

  id: string;
 
  // New multi-clinic auth mapping

  // doctors.id = staff/profile row id
  ...
  // Optional because your table may or may not already have this column.
