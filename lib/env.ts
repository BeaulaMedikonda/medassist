...
export const serverEnv = {
  ...
  sarvamEnableDiarization:
    (process.env.SARVAM_ENABLE_DIARIZATION || "true") === "true",
  sarvamPollIntervalMs: Number(process.env.SARVAM_POLL_INTERVAL_MS || 5000),
  ...
  anthropicMaxTokens: Number(process.env.ANTHROPIC_MAX_TOKENS || 2000),
  ...
  pdfIncludeDoctorNotesByDefault:
    (process.env.PDF_INCLUDE_DOCTOR_NOTES_BY_DEFAULT || "false") === "true",
};
